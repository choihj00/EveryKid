package com.capstone.everykid_test;
...
public class ChatActivity extends AppCompatActivity {
    ...
    com.capstone.everykid_test.ChatAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter=new com.capstone.everykid_test.ChatAdapter(messageItems,getLayoutInflater());
